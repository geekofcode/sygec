...
?>
    ...
    <div class="jouissance-form">
        ...
        <?php echo $form->field($model, 'TYPES')->dropDownList(["01"=>"JOUISSANCE TOTALE","02"=>"JOUISSANCE PARTIELLE","04"=>"RELIQUAT CONGE"],['prompt'=>'Choisir','disabled'=>($model->STATUT == "B")?false:true,'id'=>'types','onchange'=>'choix()']);   ?>
